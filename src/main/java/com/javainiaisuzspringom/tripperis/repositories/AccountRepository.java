...
public interface AccountRepository extends JpaRepository<Account, Integer> {
     ...
     * @param accountId account id for which trips will be retrieved
     ...
     */
    @Query("SELECT NEW com.javainiaisuzspringom.tripperis.dto.CalendarTripEntry" +
            ...
            "WHERE ((ts.startDate >= :periodStart AND ts.endDate <= :periodEnd) " +
                ...
                "AND a.id = :accountId " +
            "GROUP BY t")
    List<CalendarTripEntry> getTripDates(Integer accountId, Timestamp periodStart, Timestamp periodEnd);
